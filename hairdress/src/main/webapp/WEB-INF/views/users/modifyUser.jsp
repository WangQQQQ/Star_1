...
<!-- navbar -->
	...
	<!-- main container -->
    <div class="content">
           <c:set value="${pageContext.request.contextPath}/updateUser" var="url"></c:set>
           <c:if test="${ modifyUser.userId!=null}">
           <c:set value="${pageContext.request.contextPath}/updateUser/${modifyUser.userId}" var="url"></c:set>
           </c:if>
            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                     <form:form action="${url}" method="POST" modelAttribute="modifyUser"
	            	class="new_user_form inline-input"  onsubmit="return check()">
	              	<c:if test="${ modifyUser.userId!=null}">
                    <input type="hidden" id="_oldLastName" value="${modifyUser.userName }" />
          <form:hidden path="userId"/>
          <input type="hidden" name="_method" value="PUT"/>
        </c:if>
         <div class="span12 field-box">
         <label>姓名:</label>
		<form:input class="span6" path="userName" id="userName" />
		 <%-- <span id="errorMessage" style="color:red" >${errorMessage}</span> --%>
         </div>
        <!--  <div class="span12 field-box"> -->
		 <!--  <label>密码:</label> -->
		    <form:input class="span6" path="password" type="hidden"/>
		<!--  </div> -->
		 <div class="span12 field-box">
		<label>类别:</label>
		<form:select path="userLevel" items="${userLevel}" style="height:30px" />
		</div>
