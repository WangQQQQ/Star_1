    ...
    <div class="row-fluid login-wrapper">
        ...
        <div class="span4 box">
            <div class="content-wrap">
                ...
                <input class="span12" type="text" placeholder="用户名" name="username" id="username" value="${username}"/>
                <input class="span12" type="password" placeholder="密码" name="password" id="password" value="${password}"/>
