...
sLoadingRecords:"Loading...",sInfo:"从第 _START_ 到第 _END_ ；共 _TOTAL_ 个",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sInfoThousands:",",sSearch:"",sUrl:"",oPaginate:{sFirst:"第一页",sPrevious:"前一页",sNext:"后一页",sLast:"最后一页"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
