        ...
        <ul id="dashboard-menu">
            ...
            <li class="active">
                ...
                <ul class="active submenu">
                    ...
                    <li><a href="projectList" class="active">城建信息显示/修改</a></li>
            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <form action="searchProject" method="post">
                        <input type="text" class="span5 search" placeholder="输入要查询的项目编号或项目名称" name="searchName"/>
	             ...
	             <c:forEach items="${page.content }" var="project">
	              <tr class="first">
                      ...
                      <td>${project.projectStatus.sName }</td>
                       <td>
                           <a href="${pageContext.request.contextPath }/modifyProject/${project.pId}">
                           <span class="label label-info">修改</span>
                           
                          </a>
                        </td>
                        <td>
                        <a href="${pageContext.request.contextPath }/deleteProject/${project.pId}" class="delete"><span class="label">删除</span></a>
