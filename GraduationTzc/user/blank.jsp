			...
			<div id="main-content" class="clearfix">
					...
					<div id="breadcrumbs">
						...
						<div class="page-header position-relative">
							<h1>图表分析 <small><i class="icon-double-angle-right"></i></small></h1>
					...
					<div id="page-content" class="clearfix">
						...
						<img alt="班级已解决题目统计图"
						src="/GraduationTzc/chart/findSolveProChart">
						
						<img alt="班级难度分统计图"
						src="/GraduationTzc/chart/findSourceProChart">
						
						 <img alt="班级难度分统计图"
						src="/GraduationTzc/chart/findSourceProByAvgChart">
